...
const handleUpdate =(event)=>{
  ...
  return (
    <div className="d-flex justify-content-center w-100 align-items-center vh-100 bg-light">
    <div className="w-50 border bg-white shadow px-5 pt-3 pb-5 rounded">
      ...
      <form onSubmit={handleUpdate}>
        ...
        <input type="text" name='phone'className='form-control'placeholder='Enter Your Phone Number' value={values.phone} onChange={e=>setValues({...values, phone : e.target.value})}/> 
        </div>
